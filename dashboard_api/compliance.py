...
CONTROLS = [
    ...
    {"id": "DR-RESIDENCY", "title": "Data residency control (self-hosted; documented, pinnable egress)",
     "soc2": ["C1.1"], "iso27001": ["A.5.23"], "status": "implemented",
     "evidence": ["docs/DATA_RESIDENCY.md",
                  "self-hosted store; every external egress point is opt-in and pinnable/disable-able"]},
    ...
    {"id": "PR-DSAR", "title": "Data-subject rights (GDPR export + erasure)",
     "soc2": ["P5.1", "P4.2"], "iso27001": ["A.5.34"], "status": "implemented",
     "evidence": ["dashboard_api/privacy.py", "/privacy export + anonymising erasure"]},
