...
const STATS = [
  { value: '2.1M+', label: 'IOCs Ingested Daily', color: 'text-magenta' },
  { value: '5', label: 'OSINT Feed Sources', color: 'text-magenta' },
  { value: '4', label: 'Log Parsers', color: 'text-violet' },
  { value: '4', label: 'Anomaly Detectors', color: 'text-violet' },
  { value: 'STIX 2.1', label: 'Export Format', color: 'text-amber' },
